...
console.log(windowHeight);
  ...
  // jQuery('#prop-wrap').css('height',windowHeight-100);
  jQuery('#clients-main').css('height',windowHeight);
  ...
  var wrapper = jQuery("#wrapper"),
    ...
    var $this = jQuery(this),
      ...
      tl.to('#back-to',0,{display:'none'})
        ...
        .to(window, 1, {scrollTo:jQuery(href).offset().top-50, opacity:1,ease:Power2.easeInOut})
...
jQuery('.app-btn').on('click',function(e){
  e.preventDefault();
  var tl = new TimelineLite();
  tl.to('.app-btn',.5,{opacity:0,ease:Power2.easeIn})
    .to(window,1.5,{scrollTo:jQuery('#application').offset().top,ease:Power2.easeIn})
    .to('#application',0,{display:'block'})
...
jQuery('#Sunset-link').on('click',function(e){
  ...
  jQuery('.condo1,.condo2,.condo3,.condo4,.condo5').hover(function(){
    ...
    var content = jQuery(this).children('.prop-content');
    TweenMax.to(content,1,{top:'400px',paddingTop:0,paddingLeft:5,paddingRight:5, ease: Power2.easeOut });
  });
